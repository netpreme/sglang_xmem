...
class ServerArgs:
    ...
    def add_cli_args(parser: argparse.ArgumentParser):
        ...
        parser.add_argument(
            ...
            default=ServerArgs.hicache_use_xmem,
            help="Use X-Mem (MTier) for host KV cache allocation. "
            "When disabled, falls back to standard CPU DRAM pinned memory.",
        )
        parser.add_argument(
